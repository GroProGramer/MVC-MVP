...
public class ClockView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 1; i < 13; i++) {
            ...
            canvas.drawLine(width / 2, height / 2 - radius, width / 2, height / 2 - radius +radius/10, circlePaint);
            //画表盘数字1.要绘制的文本，2.文本x轴坐标，3.文本基线，4.文本画笔
            canvas.drawText(i + "", width / 2, height / 2 - radius + radius/10, numPaint);
            //恢复画布状态
            canvas.restore();
        }
        //获得当前小时
